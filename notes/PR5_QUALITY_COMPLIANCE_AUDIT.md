...
1. 三项 P0 gate（module graph、D0 WebView、feature transport）均已完成迁移实现，待各自当前 SHA 的 macOS CI 闭环；接着按 P1 顺序迁移 visual/accessibility source-text gate，以免任何后续 TODO 的 CI 继续将源码关键词匹配误作为质量证据。
