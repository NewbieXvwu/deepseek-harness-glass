...
def swift_source(entries: list[dict[str, object]], commit: str, locale_revision: str) -> str:
    values = {
...
def main() -> None:
    ...
    args.swift_output.write_text(swift_source(entries, commit, locale_revision), encoding="utf-8")
