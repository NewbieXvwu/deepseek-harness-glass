...
for (const name of [
  ...
  'capture-official-cut1.8-details.e2e.ts',
  'capture-official-cut1.8-queue.e2e.ts',
  'capture-official-cut1.8-cold-blank.e2e.ts',
]) {
...
await import('./capture-official-cut1.8-details.e2e.ts')
await import('./capture-official-cut1.8-queue.e2e.ts')
await import('./capture-official-cut1.8-cold-blank.e2e.ts')
