...
enum SnapshotExporter {
    ...
    static func exportIfRequested() async throws -> Bool {
        ...
        case "conversation", "jobs", "todo", "goal", "queue", "trajectory", "retry", "compaction", "feedback", "model", "permission", "deliverables":
            mode = .conversation
        ...
        case .conversation where requestedMode == "goal":
            ...
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "queue":
            sessionStore.loadSnapshotQueueFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "retry":
            sessionStore.loadSnapshotRetryFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "compaction":
            sessionStore.loadSnapshotCompactionFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "feedback":
            sessionStore.loadSnapshotFeedbackFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "deliverables":
            sessionStore.loadSnapshotDeliverablesFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "model":
            sessionStore.loadSnapshotModelSelectionFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "permission":
            sessionStore.loadSnapshotPermissionFixture()
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .conversation where requestedMode == "trajectory":
            sessionStore.loadSnapshotToolingFixture()
            sessionStore.selectView("trajectory")
            workspaceStore.loadSnapshotFixtureWorkspace()
        case .tooling:
            sessionStore.loadSnapshotToolingFixture()
        case .approval:
