...
/// Source: `packages/feedback/message-feedback/src/types.ts` at rc.1.
...
struct MessageFeedbackPutRequest: Codable, Sendable, Equatable {
    ...
    let rating: MessageFeedbackRatingDTO
    let note: String?
    /// rc.1 distinguishes an explicit null (require absent) from an omitted wire field.
...
/// Stable rc.1 business error carrier. Optional fields cover the precise
...
/// Source: rc.1 `subagents.ts:13-63`. `kind` controls which optional fields are
...
/// rc.1 `SubagentAddress` narrowed to the only mode permitted for prompt and
