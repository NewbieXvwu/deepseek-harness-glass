...
官方基线固定为 `deepseek-ai/deepseek-harness@528c682e061696f5a160f363f236ecbf53cbd006`；支持的 Host 记录在 `glass/Sources/Spec/SupportedHostBuilds.json`。一切以锁定源码为准，官方仓库的当前内容和个人记忆都不算数。
